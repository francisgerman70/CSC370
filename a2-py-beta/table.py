...
sample_db = Database([ \
            ...
            Table('Room', set(['room_id', 'max_capacity', 'building_id']), set(['room_id', 'building_id']), set([(('building_id',), 'Building', ('building_id',))])), \
            Table('Desk', set(['desk_id','room_id', 'building_id']), set(['desk_id','room_id', 'building_id']), set([(('room_id', 'building_id'), 'Room', ('room_id', 'building_id'))])), \
            Table('Class', set(['crn', 'room_id', 'building_id']), set(['crn']), set([(('room_id', 'building_id'), 'Room', ('room_id', 'building_id'))])), \
        ])
