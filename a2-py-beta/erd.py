...
#sample_erd = ERD( \
 #   [Relationship('Contains', [], ['feel'])], \
  #  [EntitySet('Building', ['latitude', 'longitude', 'name'], ['latitude'], [('Contains', Multiplicity.ONE)], [], []), \
   # EntitySet('Room', ['floor', 'name','longitude','latitude'], ['name'], [('Contains', Multiplicity.MANY)], [], [])])
    #sample_erd = ERD( \
    #[Relationship('R1',[],['hg'])], \
...
#sample_erd = ERD( \
 #   [Relationship('R',['x'],['x'])], \
  #  [EntitySet('A', ['a1','a2'], ['a1'], [('R', Multiplicity.MANY)], [], []), \
   #  EntitySet('B', ['b1','b2'], ['b1'], [('R', Multiplicity.ONE)], [], [])])
#sample_erd = ERD( \
#[], \
#[EntitySet('A', ['a1'], ['a1'], [], [], [])])
#sample_erd = ERD([], [EntitySet('A', ['a1'], ['a1'], [], [], [])])
#sample_erd = ERD( \
...
#sample_erd = ERD( \
 #   [Relationship('Rel', ['d'], [])], \
  #  [EntitySet('T', ['g', 'h'], ['h'], [('Rel', Multiplicity.ONE)], [], []), \
   # EntitySet('R', ['a', 'c'], ['a'], [('Rel', Multiplicity.MANY)], [], []), \
    #EntitySet('S', ['e', 'f'], ['e', 'f'], [('Rel', Multiplicity.MANY)], [], [])])
#sample_erd = ERD(
#	[Relationship('R1', [], [])],
#	[EntitySet('A', ['a1','a2'], ['a1'], [('R1', Multiplicity.MANY)], [], []),
#sample_erd = ERD(
